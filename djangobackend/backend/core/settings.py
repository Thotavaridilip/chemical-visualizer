...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-e2ovm0l8&8=#x8zu^v#$z#@2i)02_@s!q4$(b&8i9=$^+qiscb')
...
TEMPLATES = [
    {
        ...
        # Serve frontend built files (Vite `dist`) as templates/static
...
# For production you can store media in S3 using django-storages; set DEFAULT_FILE_STORAGE accordingly
